...
class DatapathState extends ChangeNotifier {
  ...
  final List<Bus> buses = [
    Bus(startPointLabel: 'NPC-0', endPointLabel: 'NPC-1', isActive: (s) => true),

    // Salida del PC se reparte a 3 sitios (efecto "joint" o "BusGroup")
    Bus(startPointLabel: 'PC-1', endPointLabel: 'PC-2', isActive: (s) => s.isPCActive),
    Bus(startPointLabel: 'PC-2', endPointLabel: 'NPC-2', isActive: (s) => s.isPCActive,waypoints: List.of([Offset(260,180)])),
    Bus(startPointLabel: 'PC-2', endPointLabel: 'IM-0', isActive: (s) => s.isPCActive),
    Bus(startPointLabel: 'PC-2', endPointLabel: 'BR-1', isActive: (s) => s.isPCActive,waypoints: List.of([Offset(260,440)])),

        // Sumador del PC a Mux del PC
    Bus(startPointLabel: 'NPC-3', endPointLabel: 'NPC-4', isActive: (s) => s.isPcAdderActive),
    Bus(startPointLabel: 'NPC-4', endPointLabel: 'M2-0', isActive: (s) => s.isPcAdderActive,waypoints: List.of([Offset(420,80),Offset(20,80),Offset(20,228)] )),
    Bus(startPointLabel: 'NPC-4', endPointLabel: 'M1-0', isActive: (s) => s.isPcAdderActive,waypoints: List.of([Offset(1270,150),Offset(1270,228)] )),


    Bus(startPointLabel: 'IM-1', endPointLabel: 'IB-0', isActive: (s) => s.isIMemActive),
    Bus(startPointLabel: 'IB-4', endPointLabel: 'RF-0', isActive: (s) => s.isIMemActive,width: 2),
    Bus(startPointLabel: 'IB-5', endPointLabel: 'RF-1', isActive: (s) => s.isIMemActive,width: 2),
    Bus(startPointLabel: 'IB-6', endPointLabel: 'RF-2', isActive: (s) => s.isIMemActive,width: 2),
    Bus(startPointLabel: 'IB-7', endPointLabel: 'EXT-0', isActive: (s) => s.isIMemActive),

    Bus(startPointLabel: 'EXT-2', endPointLabel: 'BR-0', isActive: (s) => s.isExtenderActive),
    Bus(startPointLabel: 'EXT-3', endPointLabel: 'M3-1', isActive: (s) => s.isExtenderActive,waypoints: List.of([Offset(820,302)])),

    Bus(startPointLabel: 'BR-2', endPointLabel: 'M2-1', isActive: (s) => s.isBranchAdderActive,waypoints:List.of([Offset(1000,410),Offset(1000,500),Offset(20,500),Offset(20,248)]  )),

    // Salida del Mux del PC a la entrada del PC
    Bus(startPointLabel: 'M2-5', endPointLabel: 'PC-0', isActive: (s) => s.isMux2Active),

    Bus(startPointLabel: 'RF-5', endPointLabel: 'ALU-0', isActive: (s) => s.isRegFileActive),
    Bus(startPointLabel: 'RF-6', endPointLabel: 'M3-0', isActive: (s) => s.isRegFileActive),
    Bus(startPointLabel: 'RF-7', endPointLabel: 'DM-1', isActive: (s) => s.isRegFileActive,waypoints: List.of([Offset(770,330),Offset(1050,330),Offset(1050,290)])),

    Bus(startPointLabel: 'M3-3', endPointLabel: 'ALU-1', isActive: (s) => s.isMux3Active),

    Bus(startPointLabel: 'ALU-4', endPointLabel: 'DM-0', isActive: (s) => s.isAluActive),
    Bus(startPointLabel: 'ALU-5', endPointLabel: 'M1-1', isActive: (s) => s.isAluActive,waypoints: List.of([Offset(1070,190),Offset(1250,190),Offset(1250,248)])),
    
    Bus(startPointLabel: 'DM-3', endPointLabel: 'M1-2', isActive: (s) => s.isDMemActive),

    Bus(startPointLabel: 'M1-5', endPointLabel: 'RF-3', isActive: (s) => s.isMux1Active,waypoints:List.of([Offset(1400,260),Offset(1400,340),Offset(600,340),Offset(600,296)]  )),
...
// Señales de estado
    ...
    Bus(startPointLabel: 'CU-0', endPointLabel: 'M2-4', isActive: (s) => s.isControlActive,waypoints: List.of([Offset(75,-30)]),isControl: true),
...
bool get isControlActive => _isControlActive;
  ...
  void _evaluateActiveComponents() {
    ...
    _isDMemActive = _isComponentReady('mem_read_data_bus');
    _isMux1Active = _isComponentReady('mux_wb_bus'); // Mux para Write Back
    _isMux2Active = _isComponentReady('mux_pc_bus'); // Mux para PC
    _isMux3Active = _isComponentReady('mux_alu_b_bus'); // Mux para entrada B del ALU
  }
