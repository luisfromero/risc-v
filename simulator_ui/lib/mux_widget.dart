...
class _MuxPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.moveTo(size.width * 0.7, 0); // Punto inicial superior-izquierda
    path.lineTo(size.width * 0.9, size.height * 0.5); // Línea a superior-derecha
    path.lineTo(size.width * 0.7, size.height); // Punto inicial superior-izquierda
